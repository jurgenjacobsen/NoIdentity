...
exports.run = async (Discord, client, message, args, i18n) => {
    ...
    if(text.length > 100) return message.channel.send(message.author, TextTooLong);
    message.channel.startTyping();
    fetch(`https://nekobot.xyz/api/imagegen?type=changemymind&text=${encodeURIComponent(text)}`)
        .then(res => res.json())
...
exports.help = {
	name: 'changemymind',
	category: 'Diversão',
	description: 'Faz um photoshop com o changemy mind',
